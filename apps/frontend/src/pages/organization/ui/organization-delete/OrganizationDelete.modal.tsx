...
const OrganizationDeleteModal: React.FC<IOrganizationDeleteModalProps> = ({
  organizationId,
  onSuccess,
  onStartDelete
}) => {
      ...
      >
        <div className='hs-tooltip inline-block'>
          ...
          <span
            ...
            role='tooltip'
            style={{ position: 'fixed', left: '238.883px', top: 51 }}
            ...
            <div className='flex gap-x-4 md:gap-x-7'>
              ...
              <div className='grow'>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Вы действительно хотите удалить этот склад? Действие нельзя будет отменить.
                  </DialogDescription>
                </DialogHeader>
              </div>
            </div>
